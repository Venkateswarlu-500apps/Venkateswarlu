        ...
        <b-navbar v-b-scrollspy:scrollspy-nested class="flex-column">
          ...
          <b-nav pills vertical>
            ...
            <b-nav pills vertical>
              ...
              <b-nav-item class="ml-3 my-1" href="#item-2-1">Item 2-1</b-nav-item>
              
              <b-nav-item class="ml-3 my-1" href="#item-2-2">Item 2-2</b-nav-item>
...
<b-card class="w-75">
      <b-col cols="8">
        <div id="scrollspy-nested" style="position:relative; height:350px; overflow-y:auto">
          ...
          <h5 id="item-2-1" style="">Item 2-1</h5>
          <p>{{ text }}</p>

          <h5 id="item-2-2" style="">Item 2-2</h5>
          <p>{{ text }}</p>
