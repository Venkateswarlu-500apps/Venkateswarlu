      ...
      <b-tabs card>
        <b-tab v-for="i in tabs" :key="i" :title="'Form' + i">
          ...
          <b-form name="form" class="w-50">
           ...
           <b-form-input type="text" v-model="fname" placeholder="Enter your FName" required></b-form-input>
           </div>
           ...
           <b-form-input type="text" v-model="lname" placeholder="Enter your LName" required></b-form-input>
           </div>

           <div class="input-group mb-3">
           <div class="input-group-prepend">
           <span class="input-group-text">EnterPassword</span>
           </div>
           <b-form-input type="password" v-model="Epassword" placeholder="Enter your Password" required></b-form-input>
           </div>
           ...
           <b-form-input type="password" v-model="Cpassword" placeholder="Enter your Confirm Password" required></b-form-input>
           </div>
